...
class DetailActivity : BaseActivity<DetailViewModel>() {
    ...
    override fun setupView(bundle: Bundle?) {
        ...
        var img: ImageView = findViewById(R.id.icon)
        var data: ResponseData = intent.getSerializableExtra("image") as ResponseData
        img.setTransitionName(intent.getStringExtra("transition"));
        text.text = data.name
        ...
        imageLoader.DisplayImage(data.avatar, R.drawable.ic_launcher_background, img);
